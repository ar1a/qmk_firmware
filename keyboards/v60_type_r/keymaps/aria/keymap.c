...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_60_ansi(
	       ...
	       KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,                                      MO(_FN),   KC_RGUI, KC_APP,  KC_RCTL),

  /* Keymap 1: FN Layer
   * ,-----------------------------------------------------------.
   * |`  | F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|  Del  |
   * |-----------------------------------------------------------|
   * |     |Cap|Up |   |   |   |   |   |Prt|Scl|Pau|Up|   | Ins  |
   * |-----------------------------------------------------------|
   * |      |Lft|Dwn|Rig|   |   |Lef|Dow|Up |Rig|Hom|PgU|        |
   * |-----------------------------------------------------------|
  ...
  [_FN] = LAYOUT_60_ansi(
	       ...
	       _______,   KC_CAPS,  KC_UP,    _______,  _______,  _______,  _______,   _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,    _______,          KC_INS, \
	       _______,   KC_LEFT,  KC_DOWN,  KC_RIGHT, _______,  _______,  KC_LEFT,   KC_DOWN, KC_UP, KC_RIGHT, KC_HOME, KC_PGUP,          _______,          \
	       _______,   _______,  _______,  _______,  _______,  KC_VOLD,   KC_VOLU, KC_MUTE, KC_END,  KC_PGDN,  KC_DOWN,           _______,  \
