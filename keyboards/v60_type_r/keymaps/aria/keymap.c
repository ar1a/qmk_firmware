...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT_60_ansi(
    ...
    _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_SLCK,  KC_PAUS,  KC_INS, \
    _______,   _______,  _______,  _______,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_HOME,  KC_PGUP,  _______,          \
    _______,   _______,  _______,  KC_CAPS,  _______,  KC_VOLD,  KC_VOLU,  KC_MUTE,  KC_END,   KC_PGDN,  TG(_AR),  _______,  \
